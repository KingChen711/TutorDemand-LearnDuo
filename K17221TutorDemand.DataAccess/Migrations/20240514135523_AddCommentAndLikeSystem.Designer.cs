...
namespace K17221TutorDemand.DataAccess.Migrations
{
    ...
    [Migration("20240514135523_AddCommentAndLikeSystem")]
    partial class AddCommentAndLikeSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommentUserLikes", b =>
                {
            ...
            modelBuilder.Entity("K17221TutorDemand.Models.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PostUserLikes", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CommentUserLikes", b =>
                {
                    b.HasOne("K17221TutorDemand.Models.Entities.Comment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostUserLikes", b =>
                {
                    b.HasOne("K17221TutorDemand.Models.Entities.Post", null)
                        .WithMany()
                        .HasForeignKey("PostId")
                        .HasPrincipalKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
